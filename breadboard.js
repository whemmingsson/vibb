class Breadboard {
    ...
    _createGate(gateDef, x, y) {
        state.register(new Gate(x, y, 180, 80, gateDef));
    }

    _setupGates() {
        const create = this._createGate;
        create(Gates.And, 180, 100);
        create(Gates.Nand, 550, 100);
        create(Gates.Or, 180, 250);
        create(Gates.Nor, 550, 250);
        create(Gates.Xor, 180, 400);
        create(Gates.Xnor, 550, 400);
        create(Gates.Not, 180, 550);
    }
